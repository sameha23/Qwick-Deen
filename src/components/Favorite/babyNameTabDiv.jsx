...
const tabData = [
  { id: 1, header: "Aabid", paragraph: "", isActive: false },
  { id: 2, header: "Aabid", paragraph: "", isActive: false },
  { id: 3, header: "Aabid", paragraph: "", isActive: false },
  { id: 4, header: "Aabid", paragraph: "", isActive: false },
];

export const BabyNameTabDiv = () => {
