...
const tabData = [
    { id: 1, header: "The Book of Good Manners", paragraph: "", isActive: false },
    { id: 2, header: "The Book of Good Manners", paragraph: "", isActive: false },
    { id: 3, header: "The Book of Good Manners", paragraph: "", isActive: false },
    { id: 4, header: "The Book of Good Manners", paragraph: "", isActive: false },
  ];
  
  

export const HadithTabDiv = () => {
