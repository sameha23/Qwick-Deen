...
const tabData = [
  ...
  { id: 9, header: "AL-Fatihah", paragraph: "The Opener", isActive: false },
  { id: 10, header: "AL-Fatihah", paragraph: "The Opener", isActive: false },
  { id: 11, header: "AL-Fatihah", paragraph: "The Opener", isActive: false },
  { id: 12, header: "AL-Fatihah", paragraph: "The Opener", isActive: false },
  // ... continue adding other tab objects if needed
];


export const SuraTabDiv = () => {
          ...
          {tabData.map((tab) => (
            <div
              ...
              className={`w-[164px] h-[60px] md:w-[263px] md:h-[78px] rounded-md md:rounded-xl p-5 flex relative items-center ${
                activeTab === tab.id ? "bg-gradient-to-l from-[#179F70] to-[#43B156]" : "bg-[#FCF3DD]"
              }`}
            >
              <span
